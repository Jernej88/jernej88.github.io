...
BLOG_AUTHOR = "Jernej Zupančič"  # (translatable)
BLOG_TITLE = "Jernej Zupančič blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://jernejzupancic.si/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://jernejzupancic.si/"
BLOG_EMAIL = "jernej@jernejzupancic.si"
BLOG_DESCRIPTION = "Blog on technical stuff, software development, work and life."  # (translatable)
...
NAVIGATION_LINKS = {
    ...
    "sl": (
        ("/sl/blog/", "Blog"),
        ("/sl/archive.html", "Arhiv"),
        ("/sl/categories/", "Značke"),
        ("/sl/rss.xml", "vir RSS"),
    ),
}
...
# is in the manual.
COMMENT_SYSTEM_ID = "jernejzupancic"
